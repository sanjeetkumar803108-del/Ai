const normQuery = "latest SCHLORSHIPS of buddy4study".toLowerCase();
...
console.log("korea:", isKorea);
console.log("germany:", isGermany);
console.log("japan:", isJapan);
console.log("uk:", isUK);
console.log("india:", isIndia);
console.log("girls:", isGirls);
